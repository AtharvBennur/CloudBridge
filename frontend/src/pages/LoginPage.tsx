                ...
                <div className="relative">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Button
                        variant="outline"
                        className="h-10 border-white/10 bg-white/5 hover:bg-white/10 text-white hover:text-white transition-colors"
                      >
                    ...
                    <div className="text-center text-sm text-muted-foreground pt-4 border-t border-white/10">
                      <span className="flex items-center justify-center gap-2">
                        ...
                        {isCognitoPrepared ? "AWS Cognito Authentication" : "Local Authentication"}
                      </span>
                    </div>
                  </CardContent>
                </div>
